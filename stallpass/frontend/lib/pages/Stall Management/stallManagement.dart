          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(title: Text("Dashboard", style: TextStyle(color: Colors.white))),
                ListTile(title: Text("Stall Management", style: TextStyle(color: Colors.white))),
                ListTile(title: Text("Open Stalls", style: TextStyle(color: Colors.white))),
                ListTile(title: Text("Closed Stalls", style: TextStyle(color: Colors.white))),
              ],
            ),
          ),
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Create Stall:", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          TextField(controller: nameController, decoration: InputDecoration(labelText: "Stall Name")),
                            ...
                            children: [
                              ...
                              ListView(
                                children: [
                                  ...
                                  StallTile(title: "ABSA Group: Education and Skill Development"),
                                ],
                              ),
